  ...
  useEffect(() => {
    const handleResponse = async () => {
      ...
      try {
        ...
        console.log("MSAL initialized successfully at", new Date().toLocaleString("th-TH", { timeZone: "Asia/Bangkok" }));
...
;
  ...
  if (isLoading) {
    return (
      <div className="text-center p-8">
        กำลังประมวลผลการเข้าสู่ระบบ... <br />
  ...
  return (
    <div className="text-center p-8">
      <p className="text-lg text-green-700">กำลังเปลี่ยนเส้นทาง</p>
      <p className="text-gray-600 mt-2">Debug Info: {debugInfo}</p>
    </div>
  );
}